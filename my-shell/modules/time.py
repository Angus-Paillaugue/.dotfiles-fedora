...
class CalendarDropdown(WaylandWindow):
    def __init__(self, parent_button, **kwargs):
        ...
        self.month_nav.pack_start(self.prev_month_btn, False, False, 0)  # Don't expand or fill
        self.month_nav.pack_start(self.month_label, True, True, 0)       # Expand and fill
        self.month_nav.pack_start(self.next_month_btn, False, False, 0)  # Don't expand or fill
    ...
    def toggle_visibility(self):
        try:
            ...
            print(f"Error toggling calendar visibility: {e}")
